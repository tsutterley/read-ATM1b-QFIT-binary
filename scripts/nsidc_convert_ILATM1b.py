...
UPDATE HISTORY:
    Updated 12/2022: add software information to output HDF5 file
...
def HDF5_icebridge_ATM1b(ILATM1b_MDS,FILENAME=None,INPUT_FILE=None,HEADER=''):
    ...
    rx=re.compile((r'(BLATM1B|ILATM1B|ILNSA1B)_((\d{4})|(\d{2}))(\d{2})(\d{2})'
        r'(.*?)\.qi$'),re.VERBOSE)
    ...
    fileID.attrs['software_reference'] = ATM1b_QFIT.version.project_name
    fileID.attrs['software_version'] = ATM1b_QFIT.version.full_version
    fileID.attrs['software_revision'] = ATM1b_QFIT.utilities.get_git_revision_hash()
