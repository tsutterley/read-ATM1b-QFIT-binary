...
project = 'read-ATM1b-QFIT-binary'
...
# html_title = "read-ATM1b-QFIT-binary"
html_short_title = "read-ATM1b-QFIT-binary"
...
repository_url = f"https://github.com/tsutterley/read-ATM1b-QFIT-binary"
html_context = {
    "menu_links": [
        (
